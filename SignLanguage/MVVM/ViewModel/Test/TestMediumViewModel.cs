...
{
    class TestMediumViewModel : CorePropertyChanged
    {
        ...
        public TestMediumViewModel()
        {
            WordsList.allWordsList.AddRange(WordsList.wordsCollege);
            WordsList.allWordsList.AddRange(WordsList.wordsFamily);
            WordsList.allWordsList.AddRange(WordsList.wordsLearning);
            WordsList.allWordsList.AddRange(WordsList.wordsSoftware);
        }
    }
}